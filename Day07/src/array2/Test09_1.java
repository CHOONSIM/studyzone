...
//		3. 하단 `Sort` 버튼을 누르면 정렬되는 과정을 시각적으로 확인할 수 있습니다 
		...
		//처리
		// - 선택정렬 1회차 : 0~4에서 가장 작은 값을 찾아 맨 앞의 데이터와 교체
		// - 선택정렬 2회차 : 1~4에서 가장 작은 값을 찾아 맨 앞의 데이터와 교체
		// - 선택정렬 3회차 : 2~4에서 가장 작은 값을 찾아 맨 앞의 데이터와 교체
		...
		for(int k=0; k <= data.length-1; k++){
			...
			int index = k; //0번 위치가 가장 작은 데이터라고 가정
			
			for(int i=k+1; i<data.length; i++) {  //비교
