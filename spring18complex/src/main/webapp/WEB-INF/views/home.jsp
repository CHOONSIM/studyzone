...
<%-- <div>${vo}</div> --%>
    ...
    <form method="get">
    	...
    	등급 : 
    			...
    			<input type ="checkbox" name="memberLevelList" value="관리자" ${vo.memberLevelList.contains('관리자') ? 'checked' : ''}>관리자<br><br>
    	포인트 : 
    			<input type ="number" name="minPoint" value="${vo.minPoint}">이상
    			<input type ="number" name="maxPoint" value="${vo.maxPoint}">이하<br><br>
    	가입일 : 
    			<input type ="date" name="beginJoinDate" value="${vo.beginJoinDate}">부터
    			<input type ="date" name="endJoinDate" value="${vo.beginJoinDate}">까지 <br><br>
