...
public class Test01 {
	public static void main(String[] args) {
		...
		*/
		...
		dataSource.setDriverClassName("oracle.jdbc.OracleDriver"); 		//오라크 드라이버 정보(내가 쓸 데이터베이스 종류)
		dataSource.setUrl("jdbc:oracle:thin:@localhost:1521:xe");		//DB주소 등록
		
		//명령 실행 도구 생성
		JdbcTemplate jdbcTemplate = new JdbcTemplate();		//jdbcTemplate 쏘는도구
