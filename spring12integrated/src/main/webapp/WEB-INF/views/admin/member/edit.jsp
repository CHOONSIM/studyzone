...
<table border ="1" width="400">
	<tbody>
		...
		<tr>
			<th rowspan="3">주소</th>
			<td>
				<input type="text" name="memberPost" size="6" maxlength="6" placeholder="우편번호" value="${memberDto.memberPost }">
			</td>
		</tr>
		<tr>
			<td>
				<input type="text" name="memberBasicAddr" size="40" placeholder="기본주소" value="${memberDto.memberBasicAddr }">
			</td>
		</tr>
		<tr>
			<td>
				<input type="text" name="memberDetailAddr" size="40" placeholder="상세주소" value="${memberDto.memberBasicAddr }">
			</td>
		</tr>
		<tr>
			<th>레벨</th>
